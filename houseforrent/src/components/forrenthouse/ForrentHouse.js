...
import { v4 } from 'uuid';
import { Button, TextField, Grid, Box, Typography, Paper, Container, Select, MenuItem } from "@mui/material";
...
export default function ForrentHouse() {
    ...
    const [progress, setProgress] = useState([...Array(imgUrl.length).fill(0)]);
